...
unsigned int nStakeMinAge = 60 * 60 * 2;	// minimum age for coin age: 1h
unsigned int nStakeMaxAge = 60 * 60 * 24 * 10;	// stake age of full weight: 10 y
...
const string strMessageMagic = "ChinaStarCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ChinaStarCoin
    bool fStrictPayToScriptHash = true; // Always active in ChinaStarCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ChinaStarCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "A new world, ChinaStar! Jan. 1 2017";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1483200000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 307442  : 307442;
		...
		printf("GenesisBlockInfo == %s\n", (const unsigned char*)pszTimestamp);
        printf("block.GetHash() == %s\n", block.GetHash().ToString().c_str());
        printf("block.hashMerkleRoot == %s\n", block.hashMerkleRoot.ToString().c_str());
        printf("block.nTime = %u \n", block.nTime);
        printf("block.nNonce = %u \n", block.nNonce);
		block.print();
		assert(block.hashMerkleRoot == uint256("a619e92e0bd749dc36d173afddc192126c39e993c559a48f73bfcb03b2a3a566"));
		assert(block.GetHash() == uint256("0000fcf9f33fe3a12ff838260c757803f694f438d553884d2b4f8d500cf3a51a"));
